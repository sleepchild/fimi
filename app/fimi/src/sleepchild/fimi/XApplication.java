...
public class XApplication extends Application
{
    ...
    public void onCreate(){
        super.onCreate();
        XApplication.ctx = getApplicationContext();
        App.get();
    ...
    private void log(Throwable ex){
        ...
        String dirp = "/sdcard/.sleepchild/fimi/logs/crash/";
        ...
        String msg="sleepchild.fimi: crash log\n";
        msg+= dd+"\n\n";
    ...
    public static void toast(String msg){
        Toast.makeText(XApplication.ctx, msg, 500).show();
    }
